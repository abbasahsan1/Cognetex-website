    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          onClick={handleSave}
          disabled={loading}
          className={`liquid-button px-6 py-3 rounded-xl font-semibold text-white flex items-center space-x-2 ${saved ? 'bg-green-500' : ''
            }`}
        >
      ...
      <div className="space-y-6">
        ...
        <div className="glass-morphism p-8 rounded-2xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-2">Office Address</label>
              <textarea
        ...
        <div className="glass-morphism p-8 rounded-2xl">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-2 flex items-center space-x-2">
          ...
          <div className="bg-card p-6 rounded-xl space-y-4 border border-border">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-foreground whitespace-pre-line">{contactInfo.address || 'Not set'}</p>
              </div>
            </div>
              ...
              <div className="flex space-x-3">
                {contactInfo.socialMedia.linkedin && (
                  <a href={contactInfo.socialMedia.linkedin} target="_blank" rel="noopener noreferrer"
                    className="p-2 rounded-lg bg-secondary hover:bg-primary text-muted-foreground hover:text-primary-foreground transition-colors">
