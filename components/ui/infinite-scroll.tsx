    ...
    <div className="relative overflow-hidden py-8">
      ...
      >
        {duplicatedItems.map((item, index) => (
          ...
          >
            <div className="w-24 h-24 glass-morphism rounded-2xl flex items-center justify-center border border-white/10 hover:border-orange-500/40 hover:bg-orange-500/5 transition-all duration-300 hover:scale-110 cursor-pointer relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center justify-center p-3">
                ...
                />
                <span className="text-xs text-gray-400 text-center font-medium group-hover:text-orange-400 transition-colors duration-300 line-clamp-1 w-full">
                  {item.name}
                </span>
              </div>
            </div>
