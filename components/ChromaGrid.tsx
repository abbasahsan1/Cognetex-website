    ...
    >
      {data.map((c, i) => (
        <article
          ...
          className="group relative flex flex-col w-[300px] h-[400px] rounded-[20px] overflow-hidden border-2 border-transparent transition-colors duration-300 cursor-pointer backdrop-blur-xl"
          style={{
            ['--card-border' as string]: c.borderColor || 'transparent',
            background: c.gradient || 'rgba(26, 25, 37, 0.6)',
        ...
        >
          ...
          />
          <div className="relative z-10 flex-1 p-[10px] box-border min-h-[300px]">
            <img src={c.image} alt={c.title} loading="lazy" className="w-full h-full object-cover rounded-[10px]" />
          </div>
          <footer className="relative z-10 p-3 text-white font-sans grid grid-cols-[1fr_auto] gap-x-3 gap-y-1 bg-gradient-to-t from-black/40 to-transparent">
