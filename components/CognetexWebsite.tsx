  ...
  return (
    <div className="min-h-screen text-white liquid-gradient-bg" style={{ backgroundColor: 'rgb(13, 12, 16)' }}>
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-[rgb(13,12,16)] via-[rgb(13,12,16)] to-[rgb(13,12,16)]"></div>
        {/* Floating Glass Orbs - Dark Copper Accent */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-[#E08A20]/20 to-[#E08A20]/10 rounded-full filter blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-gradient-to-br from-[#E08A20]/15 to-[#F0A040]/10 rounded-full filter blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-2/3 left-1/3 w-64 h-64 bg-gradient-to-br from-[#F0A040]/10 to-[#E08A20]/15 rounded-full filter blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <section id="team" className="py-32 px-4 relative fade-in-section">
        <div className="max-w-7xl mx-auto">
            ...
            {[
              ...
              >
                ...
                <div className="w-18 h-18 glass-morphism rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#E08A20]/80 to-[#E08A20]/80"></div>
                  <div className="relative z-10 text-white">
                    {member.icon}
                  </div>
                </div>
                <h3 className="text-xl font-bold mb-3 text-white group-hover:text-[#F0A040] transition-colors duration-300">
                  {member.role}
                </h3>
          ...
          <div className="text-center bg-gradient-to-r from-[#E08A20]/10 via-[#E08A20]/10 to-[#E08A20]/10 backdrop-blur-xl border border-[#E08A20]/30 rounded-3xl p-12">
            ...
            <a href="#" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-[#E08A20] to-[#F0A040] rounded-2xl hover:from-[#F0A040] hover:to-[#E08A20] transition-all duration-300 group">
              <span className="font-semibold text-[#8C5413]">Meet the Team</span>
